    ...
    <div class="pb-4 mt-3">
        ...
        <div class="row tab-content introduction-content mb-3 m-0" id="selfIntroEdit" v-if="!selfIntroEdit && showDetails">
            ...
            <div class="intro-tit tit-box">
                ...
                <p v-show="edit_page" class="profile-edit-txt" @click="editBox('selfIntroEdit','open')">
                    ...
                    <div class="card-carousel row mt-3">
                        ...
                        <div class="col-md-9 pr-0">
                            <div class="row col-12 face-img-block img-wrapper"> 
                                ...
                                :src="currentImage"
                                alt="faceimage"
                                class="img-fluid img-cursor" 
                                @click="imagePopup(currentImage)"   
                                />                          
                            </div>
                            <div class="row col-md-12">                                            
                                <div class="col-md-4 col-md-offset-8 pr-0 text-right">
                        ...
                        <div class="thumbnails col-md-3 text-center">
            ...
            <!--info-->
                ...
                <!-- <dd class="detail-data" v-if="selfIntroDetails.desired_location_1 || selfIntroDetails.desired_location_2 || selfIntroDetails.desired_location_3">
            ...
            <div class="row">
                ...
                <pre class="about-box b-n">{{selfIntro.self_pr}}</pre>
                </div>
            </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    ...
                    <div class="popup-databox">
                        <div class="form-group">
                            ...
                            <div class="col-md-12 p-0 drag-wrapper mt-2" style="margin-bottom: 2rem;" @drop.prevent="changeFaceImage($event)" @dragover.prevent>
                                <div class="upload-content">
                                    ...
                                    <div class="upload-btn-wrapper">
                                        ...
                                        <input type="file" class="upload-file"  accept="image/x-png,image/jpeg" @change="changeFaceImage($event)" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="popup-databox">
                        <div class="form-group" >
                            ...
                            <div class="col-md-12 p-0 mt-2" style="margin-bottom: 2rem;" @drop.prevent="changeRelatedImages($event)" @dragover.prevent>
                                <div class="upload-content">
                                    <p>
                                        <span class="icon icon-upload"><span class="path1"></span><span class="path2"></span></span>
                                    </p>
                        ...
                        <div class="row p-0">
                            <div class="col-sm-3" v-for="(path,indx) in selfIntro.related_images" :key="path.id">
                    ...
                    <div class="popup-databox">
                        <div class="form-group">
                            ...
                            <div class="row">
                                <label for="YouTubeURL" class="col-md-2 label-txt mt-2">YouTubeURL</label>
                                <div class="col-md-10">
        ...
        <div class="row tab-content information-content mb-3 m-0" id="basicInfoEdit" v-if="!basicInfoEdit && showDetails">
            <div class="col-12">
                <div class="tit-box">
                    ...
                    <p v-show="edit_page"  class="profile-edit-txt" @click="editBox('basicInfoEdit','open')"><span class="icon icon-edit align-text-bottom"></span>{{$t('common.edit')}}</p>
                </div>
                ...
                <div class="explation-note">
                    <span class="private">{{$t('jobseekerprofile.private')}}</span> {{$t('jobseekerprofile.details')}}<br> {{$t('jobseekerprofile.detailsExtra')}}<br>
                ...
                <div class="col-12">
                    ...
                    <div class="popup-databox">
                        ...
                        <div class="row">
                            ...
                            <label style="margin-bottom:17px;">{{$t('jobseekerprofile.furigana')}}
                        ...
                        <div class="row gender-group">
                            <label style="margin-bottom:17px;" for="">{{$t('jobseekerprofile.gender')}}
                            <span class="status">
                        ...
                        <div class="row">
                            <label style="margin-bottom:17px;" for="">{{$t('jobseekerprofile.date')}} 
                                <!-- <span class="private ml-4">{{$t('jobseekerprofile.private')}}</span> -->
                        ...
                        <div class="row">
                            <label style="margin-bottom:17px;" for="">{{$t('jobseekerprofile.location')}} 
                            <span class="status"> 
                        ...
                        <div class="row">
                            <label style="margin-bottom:17px;" for="">{{$t('jobseekerprofile.loca_details')}} <span class="view-permission" style="padding: 7px 10px;">{{$t('jobseekerprofile.admin')}}</span></label>
                            <div class="col-md-8 pl-0">
                                <textarea name="" id="" class="form-control" v-model="basicInfo.address"></textarea>
                            </div>
                        </div>
                        <div class="row">
                            <label style="margin-bottom:17px;" for="">{{$t('jobseekerprofile.phone')}} <span class="view-permission" style="padding: 7px 10px;">{{$t('jobseekerprofile.admin')}}</span></label>
                            <div class="col-md-8 pl-0">
                                ...
                                <div class="invalid-feedback">
                                    ...
                                    <div class="error" v-else-if="!$v.basicInfo.phone.phoneformat">{{$t('jobseekerprofile.number_only')}}</div>
                                    <!-- <div class="error" v-if="!$v.basicInfo.phone.minLength || !$v.basicInfo.phone.maxLength">{{$t('jobseekerprofile.phone_length')}}</div> -->
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <label style="margin-bottom:17px;" for="">{{$t('jobseekerprofile.email')}} <span class="view-permission" style="padding: 7px 10px;">{{$t('jobseekerprofile.admin')}}</span></label>
                            <div class="col-md-8 pl-0">
                        ...
                        <div class="row">
                            <label style="margin-bottom:17px;" for="">{{$t('jobseekerprofile.skype')}} <span class="view-permission" style="padding: 7px 10px;">{{$t('jobseekerprofile.admin')}}</span></label>
                            <div class="col-md-8 pl-0">
        ...
        <div class="row tab-content experience-content mb-3 m-0" id="careerEdit" v-if="!careerEdit && showDetails">
            <div class="col-12">
                <div class="tit-box">
                    ...
                    <p v-show="edit_page"  class="profile-edit-txt" @click="editBox('careerEdit','open')"><span class="icon icon-edit align-text-bottom align-text-bottom"></span>{{$t('common.edit')}}</p>
                </div>
                <dl class="detail-list clearfix">
         ...
         <div class="row tab-content experience-content mb-3 m-0" v-if="careerEdit">
                <div class="head-wrap col-12">
                        ...
                        <div class="col-md-12 school-box mb-4" v-for="(edu,indx) in educations" :key="edu.id">
                            ...
                            <div class="row" >
                                ...
                                <div class="row  col-md-12 mb-2">
                                    ...
                                    <label style="line-height:35px;">から</label>
                                </div>
                                <div class="row col-md-12" >
                                    <div class="col-md-2">
                                        <div class="select-wrap">
                    ...
                    <div  class="popup-databox">
                        <label class="font-weight-bold">{{$t('jobseekerprofile.workhistory')}}</label>
                        <div class="col-md-12 p-0 mb-3">                             
                            <label for="">{{$t('jobseekerprofile.experiencepeople')}}</label>
                            <div class="col-md-3">
                                <input type="text" class="form-control" v-model="carrers.num_of_experienced_companies " placeholder="経験社数を入力" />
                                <!-- <span class="error" v-if="$v.carrers.num_of_experienced_companies.$error">{{$t('jobseekerprofile.num_of_exp_comp')}}</span> -->
                            </div>
                        </div>
                       
                       <label class="font-weight-bold">{{$t('jobseekerprofile.oldjob')}}</label>
                        ...
                        <div class="col-md-12 experience-box mb-4" v-for="(exp,indx) in experiences" :key="exp.id">
                            ...
                            <div class="row col-md-12">
                                <div class=" p-0 m-0 same-check d-flex">   
                                        <span> 勤務先 {{indx+1}}   </span>
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    <label class="font-weight-bold mb-3">{{$t('jobseekerprofile.experiencetype')}}</label>                                    
                                    <label :for="'現在も在籍中'+indx" class="custom-control-label custom-checkbox-label">
                                       ...
                                       <span class="custom-check-label-post"> {{$t('jobseekerprofile.currentperoid')}}</span>
                                    </label>                              
                                </div>
                                ...
                                <div class="row col-md-12 mb-1">
                                    ...
                                    <label for="" style="line-height: 35px;">から</label>
        ...
        <div class="row tab-content qualification-content mb-3 m-0" id="expQualificationEdit" v-if="!expQualificationEdit && showDetails">
                <div class="col-12">
                    <div class="tit-box">
                        ...
                        <p v-show="edit_page"  class="profile-edit-txt" @click="editBox('expQualificationEdit','open')"><span class="icon icon-edit"></span>編集</p>
                    </div>
                    <dl class="detail-list clearfix">
                        ...
                        <dt class="detail-head">語学レベル</dt>
                        <dd class="detail-data">
                            <!-- {{experience_qualification.foreign_language_level_experiences}} -->
                            <div v-for="foreign_language_level in experience_qualification.foreign_language_level_experiences" :key="foreign_language_level.id">
                                <span v-if="foreign_language_level.foreign_language">
                                    <span v-for="language in languages" :key="'language'+language.id">
                                        <span v-if="language.id == foreign_language_level.foreign_language">{{language.language_name}}</span>
                        ...
                        <div class="col-md-12 school-box" v-for="(experience_job,index) in experience_qualification.experience_jobs" :key="experience_job.id">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-2 p-0">
                                    <div class="">
                                        <input type="number" v-model="experience_job.experience_year" class="form-control" min="0" maxlength="2"
        ...
        <div class="row tab-content condition-content m-0" id="desiredConditionEdit" v-if="!desiredConditionEdit && showDetails">
            <div class="col-12">
                <div class="tit-box">
                    ...
                    <p v-show="edit_page"  class="profile-edit-txt" @click="editBox('desiredConditionEdit','open')"><span class="icon icon-edit align-text-bottom align-text-bottom"></span>{{$t('common.edit')}}</p>
                </div>
                <dl class="detail-list clearfix">
       ...
       <div class="row tab-content condition-content m-0" v-if="desiredConditionEdit">
                <div class="col-12">
                    ...
                    <div class="popup-databox">
                        <h6 class="font-weight-bold form-group row">{{$t('jobseekerprofile.preferredindustry')}}</h6>                            
                        <div class="form-group row mb-0">        
                    ...
                    <div class="popup-databox">
                        <h6 class="font-weight-bold form-group row">{{$t('jobseekerprofile.desiredoccupation')}}</h6>
                        <div class="form-group row mb-0">
                    ...
                    <div class="popup-databox">
                        ...
                        <div class="form-group row">
                            <label for="" class="col-md-2 pl-5">{{$t('jobseekerprofile.minannulaincome')}}</label>
                            <div class="col-md-4">
                        ...
                        <div class="form-group row">
                            <label for="" class="col-md-2 pl-5">{{$t('jobseekerprofile.maxannualincome')}}</label>
                            <div class="col-md-4">
    ...
    methods: {
        ...
        changeFaceImage(e) {
            ...
            if (ext == "png" || ext == "jpg" || ext == "jpeg") {
                ...
                console.log("selfIntro.",this.selfIntro.face_image)
        ...
        editBox(boxName, action) {
            ...
            if(boxName == 'expQualificationEdit'){
                this.getJobIndustryExpDetails(jobseeker_id);
            }
        ...
        saveSelfIntro() {
            ...
            this.$api.post("/jobseeker/profile/selfintro", data).then(() => {    
                this.getSelfIntroDetails(this.$route.params.id);
                this.$alertService.showSuccessDialog( null, this.$t("alertMessage.updateSuccess"), this.$t("common.close") );
                      loading.hide();
        ...
        saveBasicInfo() {
            ...
            this.buildFormData(data, this.basicInfo);
            let loading = this.$loading.show();
            this.$api
                .post("/jobseeker/profile/basicinfo", data)
                .then((r) => {
                    console.log(r);
        ...
        // Thuzar
          ...
          saveCarrer() {
                    ...
                    for(var j =this.experiences.length-1;j>=0;j--){
                        if(this.experiences.length != 1){
                            if((this.experiences[j].job_location == null || this.experiences[j].job_location == '') && this.experiences[j].from_year == '年' && this.experiences[j].from_month == '月' && 
                                this.experiences[j].to_year == '年' && this.experiences[j].to_month == '月' && this.experiences[j].position_id == "0" && this.experiences[j].employment_type_id == "0" && 
                                (this.experiences[j].main_duty == null || this.experiences[j].main_duty == '' && this.experiences[j].private_status == 0) && (this.experiences[j].current == false || this.experiences[j].current == 0)
                                && this.exp_year_errors == '' && this.exp_month_errors == '')  {
                                this.experiences.splice(j,1);
                            }
                        }
                    ...
                    if(this.exp_year_errors == '' && this.exp_month_errors == ''){
                        ...
                        this.$api.post("/jobseeker/profile/carrer", jsonData).then(() => {
                            this.$alertService.showSuccessDialog(null, this.$t('alertMessage.updateSuccess'), this.$t('common.close'));
        ...
        // Su Sandy
        imagePopup(url){
            if(url.includes('images/default.png')){
                return false;
            }
            else{
                this.showModal =  true;
