    ...
    <div class="pb-4 mt-3">
        ...
        <div class="row tab-content introduction-content mb-3 m-0" v-if="selfIntroEdit">
            ...
            <div class="popup-databox">
                ...
                <div class="row">
                <div class="col-md-7">
                    <div class="img-wrapper face-image-wrapper">
                ...
                <div class="col-md-5">
                    ...
                    <input
                        ...
                        v-model="selfIntro.face_image_private_status"
                    />
                    <label for="japan" class="custom-radio-lable">非公開</label>
                    </p>
                </div>
                </div>
            </div>
            ...
            <div class="popup-databox">
                ...
                <div class="row">
                    <div class="col-md-3" v-for="(path,indx) in selfIntro.related_images" :key="path.id">
                        ...
                        width="100px;"
                        height="150px;"
                        class="profile-edit-img img-fluid"
                        alt
                        />
                        <button type="button" @click="deleteRelatedImage(indx)" class="delete-btn"><span class="glyphicon glyphicon-remove"></span></button>
                    </div>
                    <div v-if="imageError != ''">
            ...
            <span class="btn custom-save-btn" @click="saveSelfIntro">保存する</span>
            </p>
        </div>
        <!-- end self-intro -->
        ...
        >
            ...
            <dl class="detail-list clearfix">
                ...
                <dd class="detail-data">{{basicInfo.jobseeker_number}}</dd>
        ...
        <div class="row tab-content information-content mb-3 m-0" v-if="basicInfoEdit">
            ...
            <div class="popup-databox">
                ...
                <div class="col-md-8 p-0">
                    ...
                    <div
                        class="error"
                        v-if="!$v.basicInfo.phone.phoneformat"
            ...
            <p class="w-100 text-center mt-3">
            <span class="btn custom-save-btn border-style" @click="saveBasicInfo">保存する</span>
            </p>
        </div>
        <!-- End basic-info -->
        ...
        <div class="row tab-content experience-content mb-3 m-0" v-if="careerEdit">
            ...
            <div class="popup-databox">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8 p-0">
                       <input type="text" :class="['form-control',$v.educations.$each.$iter[indx].subject.$error?'is-invalid':'']" v-model.trim="$v.educations.$each.$iter[indx].subject.$model " placeholder="学部学科を入力" />
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-4">
                        ...
                        <option :value="null" selected>学位を選択する</option>
                        <option v-for="status in finaleducation" :key="status.id" v-bind:value="status.id">{{status.id}}</option>
                        </select>
                    </div>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-md-2 pr-1">
                        <div class="select-wrap">
                            <select :class="['form-control',$v.educations.$each.$iter[indx].from_year.$error?'is-invalid':'']" v-model.trim="$v.educations.$each.$iter[indx].from_year.$model" >
                    ...
                    <div class="col-md-2 pl-1">
                        <div class="select-wrap">
                            <select :class="['form-control',$v.educations.$each.$iter[indx].from_month.$error?'is-invalid':'']" v-model.trim="$v.educations.$each.$iter[indx].from_month.$model">
                    ...
                    <div class="col-md-2 pr-1">
                        <div class="select-wrap">
                            <select :class="['form-control',$v.educations.$each.$iter[indx].to_year.$error?'is-invalid':'']" v-model.trim="$v.educations.$each.$iter[indx].to_year.$model">
                                <option disabled :value="null">年</option>
                                <option v-for="year in 100" :key="year">{{ 1920 + year}}{{' 年'}}</option>
                            </select>
                            <span class="sort-desc">&#9662;</span>
                    ...
                    <div class="col-md-2 pl-1">
                        <div class="select-wrap">
                            <select :class="['form-control',$v.educations.$each.$iter[indx].to_month.$error?'is-invalid':'']" v-model.trim="$v.educations.$each.$iter[indx].to_month.$model">
                                <option disabled :value="null">月</option>
                                <option v-for="month in 12" :key="month">{{ month }}{{' 月'}}</option>
                            </select>
                            <span class="sort-desc">&#9662;</span>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8 p-0">
                        <div class="select-wrap">
                        <select :class="['form-control',$v.educations.$each.$iter[indx].education_status.$error?'is-invalid':'']" v-model.trim="$v.educations.$each.$iter[indx].education_status.$model">
                            <option :value="null" selected>ステータスを選択する</option>
            ...
            <div class="popup-databox">
                ...
                <div class="col-md-3 p-0">
                    <input type="text" :class="['form-control',$v.carrers.num_of_experienced_companies.$error?'is-invalid':'']" v-model.trim="$v.carrers.num_of_experienced_companies.$model " placeholder="経験社数を選択" />
                     <span class="error" v-if="$v.carrers.num_of_experienced_companies.$error">{{$t('jobseekerprofile.num_of_exp_comp')}}</span>
                    <!-- <input  type="text" v-model="carrers.num_of_experienced_companies" class="form-control" placeholder="経験社数を選択" /> -->
                </div>
                </div>
            ...
            <p class="w-100 text-center mt-3">
            <span class="btn job-primary-color custom-save-btn border-style" @click="saveCarrer">保存する</span>
            </p>
        ...
        <div class="row tab-content qualification-content mb-3 m-0" v-if="expQualificationEdit">
            ...
            <div class="popup-databox">
                ...
                <div
                class="col-md-12 school-box"
                v-for="(study_abroad_experience, index) in experience_qualification.study_abroad_experiences"
                :key="study_abroad_experience.id"
                >
                <p
                    class="delete-btn"
                    @click="deleteStudyAbroad(index, study_abroad_experience.study_abroad_id)"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="select-wrap">
                            <!-- {{study_abroad_experience.study_abroad_country}} -->
                        <select
                            class="form-control"
                            v-model="study_abroad_experience.study_abroad_country"
                        >
                            <option
                            :value="null"
                    ...
                    <div class="col-md-4">
                        ...
                        <select
                            class="form-control"
                            v-model="study_abroad_experience.study_abroad_period"
                        >
                            <option
                            :value="null"
                ...
                <div class="form-group">
                    ...
                    <div class="select-wrap">
                        <select
                        class="form-control"
                        v-model="study_abroad_experience.study_abroad_purpose"
                        >
                        <option
                            :value="null"
            ...
            <div class="popup-databox">
                ...
                <div
                class="col-md-12 school-box"
                v-for="(working_abroad_experience, index) in experience_qualification.working_abroad_experiences"
                :key="working_abroad_experience.id"
                >
                <p
                    class="delete-btn"
                    @click="deleteWorkingAbroad(index, working_abroad_experience.working_abroad_id)"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        ...
                        <select
                            class="form-control"
                            v-model="working_abroad_experience.working_abroad_country"
                        >
                            <option
                            :value="null"
                    ...
                    <div class="col-md-4">
                        ...
                        <select
                            class="form-control"
                            v-model="working_abroad_experience.working_abroad_period"
                        >
                            <option
                            :value="null"
                ...
                <div class="form-group">
                    ...
                    <div class="select-wrap">
                        <select
                        class="form-control"
                        v-model="working_abroad_experience.working_abroad_position"
                        >
                        <option
                            :value="null"
            ...
            <div class="popup-databox">
                ...
                <div class="col-md-4 p-0">
                    ...
                    <select
                        class="form-control"
                        v-model="experience_qualification.work_visa.country"
            ...
            <div class="popup-databox">
                ...
                <div
                class="col-md-12 school-box"
                v-for="(foreign_language_level_experience, index) in experience_qualification.foreign_language_level_experiences"
                :key="foreign_language_level_experience.id"
                >
                <p
                    class="delete-btn"
                    @click="deleteforeignLanguageLevel(index, foreign_language_level_experience.foreign_language_id)"
            ...
            <p class="w-100 text-center mt-3">
            <span
                class="btn appendbtn custom-save-btn border-style"
        ...
        >
            ...
            <dl class="detail-list clearfix">
                <dt class="detail-head">転職意欲</dt>
                        ...
                        <dd class="detail-data" v-if="desired_condition.desired_locations_1 || desired_condition.desired_locations_2 || desired_condition.desired_locations_3">
                            <span v-if="desired_condition.desired_locations_1"> {{desired_condition.desired_locations_1}}<br></span>
                            <span v-if="desired_condition.desired_locations_2"> {{desired_condition.desired_locations_2}}<br></span>
                            <span v-if="desired_condition.desired_locations_3"> {{desired_condition.desired_locations_3}}</span>
                        </dd>
                        <dd class="detail-data" v-else>未入力</dd>
                        ...
                        <dd class="detail-data">
                            ...
                            <span v-if="desired_condition.industry_name">
                             ...
                             <span  v-if="desired_condition.industry_name && desired_condition.industry_name.length == 0 && desired_condition.desired_industry_status == 0">未入力</span>
                        ...
                        <dd class="detail-data">
                            <span v-if="desired_condition.occupation_name">
                             ...
                             <span  v-if="desired_condition.occupation_name && desired_condition.occupation_name.length == 0 && desired_condition.desired_occupation_status == 0">未入力</span>
                      ...
                      <!-- 万 円 -->
                        ...
                        <dd class="detail-data" v-if="desired_condition.desired_min_annual_income && !desired_condition.desired_max_annual_income">{{ Number(desired_condition.desired_min_annual_income).toLocaleString() }} {{desired_condition.desired_currency}}以上 </dd>
                        <dd class="detail-data" v-if="!desired_condition.desired_min_annual_income && desired_condition.desired_max_annual_income">{{ Number(desired_condition.desired_max_annual_income).toLocaleString() }} {{desired_condition.desired_currency}} </dd>
                        <dd class="detail-data" v-if="desired_condition.desired_min_annual_income && desired_condition.desired_max_annual_income">{{ Number(desired_condition.desired_min_annual_income).toLocaleString() }} ~ {{ Number(desired_condition.desired_max_annual_income).toLocaleString() }} {{desired_condition.desired_currency}}</dd>
            </dl>
            </div>
        </div>
        <div class="row tab-content condition-content m-0" v-if="desiredConditionEdit">
            ...
            <div class="popup-databox">
                ...
                <div class="error col-12" v-if="desired_errors.occupation_error">{{desired_errors.occupation_error}}</div>
                <div v-if="!desired_condition.desired_occupation_status">
                <div  class="col-md-12 school-box" v-for="(occupation,index) in occupations" :key="index" >
            ...
            <p class="w-100 text-center mt-3">
            <span class="btn job-primary-color custom-save-btn" @click="saveDesiredCondition()">保存する</span>
            </p>
        </div>
...
<script>
    ...
    created() {
        ...
        let request_id = {};
        this.$set(request_id, "jobseekerid", `${this.$route.params.id}`);
    ...
    methods: {
        ...
        getSelfIntroDetails(request_id) {
            ...
            this.$api.get(`/jobseeker/profile/selfintro/?jobseekerid=${request_id}`).then((r) => {
        ...
        getJobIndustryExpDetails(request_id) {
            this.$api
                .post("/jobseeker/profile/experiences-qualifications", request_id)
                .then((res) => {
                    console.log(res);
        ...
        saveExpQualification() {
            ...
            this.$api.post( "/jobseeker/profile/experiences-qualifications/update", request_data )
            .then(() => {
                let request_id = {};
                this.$set(request_id, "jobseekerid", `${this.$route.params.id}`);
                this.getJobIndustryExpDetails(request_id);
        ...
        saveSelfIntro() {
            ...
            this.$api
                .post("/jobseeker/profile/selfintro", this.selfIntro)
                .then((r) => {
                    console.log(r);
                this.$alertService.showSuccessDialog( null, this.$t("alertMessage.updateSuccess"), this.$t("common.close") );
        ...
        saveBasicInfo() {
            ...
            let loading = this.$loading.show();
            this.$api
                .post("/jobseeker/profile/basicinfo", this.basicInfo)
                .then((r) => {
                    console.log(r);
        ...
        getBasicInfoDetails(request_id) {
            this.$api.get(`/jobseeker/profile/basicinfo/?jobseekerid=${request_id}`).then((response) => {
        ...
        getCity() {
            ...
            this.$api
                .get("/jobseeker/city-list/" + this.basicInfo.country_name)
                .then((res) => {
        ...
        getCarrerDetails(request_id) {
            this.$api.get(`/jobseeker/profile/carrerinfo/?jobseekerid=${request_id}`).then((response) => {
        ...
        saveCarrer() {
            ...
            // }
             for(var j =this.educations.length-1;j>=0;j--){
                if(this.educations.length != 1)
                {
                    ...
                    if((this.educations[j].school_name == null || this.educations[j].school_name == '' )  && (this.educations[j].subject == null || this.educations[j].subject == '' ) && this.educations[j].from_year == null && this.educations[j].to_year == null && this.educations[j].from_month == null && this.educations[j].to_month == null && this.educations[j].education_status == null )
                    {
            ...
            if(this.$v.educations.$error) {
                return;
            }

            this.$v.carrers.$touch();
                 if(this.$v.carrers.$error) {
                    return;
            }
            ...
            this.$api
                .post("/jobseeker/profile/carrer", jsonData)
                .then((response) => {
        ...
        this.$api
            .get(`/jobseeker/profile/desired-condition/?jobseekerid=${request_id}`)
            .then((response) => {
                ...
                console.log('desired_condition',this.desired_condition);
                ...
                //     this.occupations = [{ id: this.desired_condition.desired_occupation_id,jobseeker_id: this.desired_condition.id,}, ];
                //     this.occupations = this.occupations.concat(response.data.occupations);
                // } else {
                //     if (response.data.occupations.length) {
                //     this.occupations = response.data.occupations;
                //     } else {
        ...
        saveDesiredCondition() {
            ...
            //     // this.desired_errors.industry_error = "業種を選択してください";
            //     // }
            // }
            ...
            //     });
            //     if (indexArray.length == 0) {
            //     this.desired_errors.occupation_error = "業種を選択してください";
            //     }
            // }
            ...
            // ) {
                let loader = this.$loading.show();
                this.$api
                .post("/jobseeker/profile/desired-condition", jsonData)
                .then((response) => {
                    console.log(response);
                    this.$alertService.showSuccessDialog(
                    null,
