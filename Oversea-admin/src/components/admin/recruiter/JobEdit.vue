<template>
  <div class="user-main p-0">
    <h2 class="user-head-tit">求人編集</h2>
    <div class="content-wrap">
                ...
                <div class="col-md-12 form-bordered mt-5">
                    <div class="form-group row mb-0 d-flex">
                        ...
                        <div class="col-md-8 form-right-block">
                            ...
                            placeholder="年 - 月 - 日"
                            valueType="format"
                            v-model="formRegister.job_post_date[0]"
                            :editable="false"
                            type="date"
                            ></date-picker>
        ...
        <div class="d-flex justify-content-start mt-5">
                ...
                <!-- <router-link to="/admin/job-list" class="btn back-btn mr-4">{{ $t('common.cancel') }}</router-link> -->
...
export default {
    ...
    methods: {
         cancelBtn()
            {
                let paginate = {
                 ...
                 this.$router.push({ path: "/admin/job-list" });
        ...
        if (this.$route.params.id) {
            this.$api.post("/recruiter/jobs/" + `${this.$route.params.id}` + "/update", this.formRegister)
            .then(() => {
                ...
                //             this.$api.post("/recruiter/jobs/add", this.formRegister).then(() =>{
                //                 loading.hide();
                //                 this.$alertService.showSuccessDialog(null, '投稿しました。', this.$t('common.close'));
                //                 this.$router.push({ path: "/admin/job-list" });
                //             });
                //         }
                //     });                    
