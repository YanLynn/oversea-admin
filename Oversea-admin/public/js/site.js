...
if (
    ((function(a, b) {
            ...
            function d(a) {
                var b = (zb[a] = {});
                return (
                    kb.each(a.match(mb) || [], function(a, c) {
                        b[c] = !0;
                    }),
                    b
                );
            ...
            function e(a, c, d, e) {
                if (kb.acceptData(a)) {
                    ...
                    if ((k && j[k] && (e || j[k].data)) || d !== b || "string" != typeof c)
                        return (
                            k || (k = i ? (a[h] = bb.pop() || kb.guid++) : h),
                            j[k] || (j[k] = i ? {} : { toJSON: kb.noop }),
            ...
            function t(a, b) {
                ...
                if (1 === b.nodeType) {
                    ...
                    "script" === c && b.text !== a.text ?
                        ((p(b).text = a.text), q(b)) :
                        "object" === c ?
                        (b.parentNode && (b.outerHTML = a.outerHTML), kb.support.html5Clone && a.innerHTML && !kb.trim(b.innerHTML) && (b.innerHTML = a.innerHTML)) :
                        "input" === c && bc.test(a.type) ?
            ...
            function y(a, b) {
                for (var c, d, e, f = [], g = 0, h = a.length; h > g; g++)
                    (d = a[g]),
                    d.style &&
                    ((f[g] = kb._data(d, "olddisplay")),
                        (c = d.style.display),
                        b ?
                        (f[g] || "none" !== c || (d.style.display = ""), "" === d.style.display && x(d) && (f[g] = kb._data(d, "olddisplay", C(d.nodeName)))) :
                        f[g] || ((e = x(d)), ((c && "none" !== c) || !e) && kb._data(d, "olddisplay", e ? c : kb.css(d, "display"))));
            ...
            function A(a, b, c, d, e) {
                for (var f = c === (d ? "border" : "content") ? 4 : "width" === b ? 1 : 0, g = 0; 4 > f; f += 2)
                    "margin" === c && (g += kb.css(a, c + xc[f], !0, e)),
                    d ?
                    ("content" === c && (g -= kb.css(a, "padding" + xc[f], !0, e)), "margin" !== c && (g -= kb.css(a, "border" + xc[f] + "Width", !0, e))) :
                    ((g += kb.css(a, "padding" + xc[f], !0, e)), "padding" !== c && (g += kb.css(a, "border" + xc[f] + "Width", !0, e)));
                return g;
            }
            ...
            function C(a) {
                ...
                return (
                    ...
                    ((c = D(a, b)),
                        ("none" !== c && c) ||
                        ((jc = (jc || kb("<iframe frameborder='0' width='0' height='0'/>").css("cssText", "display:block !important")).appendTo(b.documentElement)),
                            (b = (jc[0].contentWindow || jc[0].contentDocument).document),
            ...
            function F(a) {
                return function(b, c) {
                    ...
                    if (kb.isFunction(c))
                        for (;
                            (d = f[e++]);) "+" === d[0] ? ((d = d.slice(1) || "*"), (a[d] = a[d] || []).unshift(c)) : (a[d] = a[d] || []).push(c);
                };
            }
            ...
            function O(a, b, c) {
                ...
                return (
                    ...
                    kb.fx.timer(kb.extend(i, { elem: a, anim: j, queue: j.opts.queue })),
                ...
                for ("boolean" == typeof h && ((k = h), (h = arguments[1] || {}), (i = 2)), "object" == typeof h || kb.isFunction(h) || (h = {}), j === i && ((h = this), --i); j > i; i++)
                    if (null != (f = arguments[i]))
                        for (e in f)
                            ...
                            (d = f[e]),
                            h !== d &&
                            (k && d && (kb.isPlainObject(d) || (c = kb.isArray(d))) ?
                                (c ? ((c = !1), (g = a && kb.isArray(a) ? a : [])) : (g = a && kb.isPlainObject(a) ? a : {}), (h[e] = kb.extend(k, g, d))) :
                                d !== b && (h[e] = d));
                return h;
            }),
            kb.extend({
                    ...
                    parseJSON: function(c) {
                        return a.JSON && a.JSON.parse ?
                            ...
                            null === c ?
                            c :
                            "string" == typeof c && ((c = kb.trim(c)), c && qb.test(c.replace(sb, "@").replace(tb, "]").replace(rb, ""))) ?
                            Function("return " + c)() :
                            (kb.error("Invalid JSON: " + c), b);
                    },
                    parseXML: function(c) {
                        var d, e;
                    ...
                    proxy: function(a, c) {
                        ...
                        return (
                            ...
                            kb.isFunction(a) ?
                            ((d = fb.call(arguments, 2)),
                                (e = function() {
                                    return a.apply(c || this, d.concat(fb.call(arguments)));
                                }),
                                (e.guid = a.guid = a.guid || kb.guid++),
                                e) :
                            b
                        );
                    },
                ...
                (function(a, b) {
                    ...
                    function p(a, b) {
                        ...
                        for (h = a, i = [], j = D.preFilter; h;) {
                            (!d || (e = pb.exec(h))) && (e && (h = h.slice(e[0].length) || h), i.push((f = []))), (d = !1), (e = qb.exec(h)) && ((d = e.shift()), f.push({ value: d, type: e[0].replace(ob, " ") }), (h = h.slice(d.length)));
                            for (g in D.filter) !(e = vb[g].exec(h)) || (j[g] && !(e = j[g](e))) || ((d = e.shift()), f.push({ value: d, type: g, matches: e }), (h = h.slice(d.length)));
                            if (!d) break;
                        }
                        ...
                        for (
                            ...
                            if ((c = D.relative[a[h].type])) k = [r(s(k), c)];
                                ...
                                if (((c = D.filter[a[h].type].apply(null, a[h].matches)), c[R])) {
                                    ...
                                    return u(h > 1 && s(k), h > 1 && q(a.slice(0, h - 1).concat({ value: " " === a[h - 2].type ? "*" : "" })).replace(ob, "$1"), c, d > h && v(a.slice(h, d)), e > d && v((a = a.slice(d))), e > d && q(a));
                                }
                                k.push(c);
                            }
                        return s(k);
                    ...
                    (J = c.setDocument = function(a) {
                        ...
                        return c !== K && 9 === c.nodeType && c.documentElement ?
                            ((K = c),
                                ...
                                (B.matchesSelector = d((P = L.webkitMatchesSelector || L.mozMatchesSelector || L.oMatchesSelector || L.msMatchesSelector))) &&
                                g(function(a) {
                                ...
                                (Q =
                                    d(L.contains) || L.compareDocumentPosition ?
                                ...
                                (Z = L.compareDocumentPosition ?
                                    ...
                                    function(a, b) {
                                        ...
                                        return d ?
                                            1 & d || (!B.sortDetached && b.compareDocumentPosition(a) === d) ?
                                            a === c || Q(S, a) ?
                                            -1 :
                                            b === c || Q(S, b) ?
                                            1 :
                                            I ?
                                            gb.call(I, a) - gb.call(I, b) :
                                            0 :
                                            4 & d ?
                                            -1 :
                                            1 :
                                    ...
                                    function(a, b) {
                                        ...
                                        if (f === g) return l(a, b);
                                        for (d = a;
                                            (d = d.parentNode);) h.unshift(d);
                                        for (d = b;
                                            (d = d.parentNode);) i.unshift(d);
                                        for (; h[e] === i[e];) e++;
                    ...
                    (D = c.selectors = {
                        ...
                        preFilter: {
                            ...
                            PSEUDO: function(a) {
                                var c,
                                    d = !a[5] && a[2];
                                return vb.CHILD.test(a[0]) ?
                                    null :
                                    (a[3] && a[4] !== b ? (a[2] = a[4]) : d && tb.test(d) && (c = p(d, !0)) && (c = d.indexOf(")", d.length - c) - d.length) && ((a[0] = a[0].slice(0, c)), (a[2] = d.slice(0, c))), a.slice(0, 3));
                            },
                        },
                        filter: {
                            TAG: function(a) {
                                    ...
                                    function(b, c, i) {
                                        ...
                                        if (q) {
                                            ...
                                            if (((o = [g ? q.firstChild : q.lastChild]), g && s)) {
                                                for (k = q[R] || (q[R] = {}), j = k[a] || [], n = j[0] === T && j[1], m = j[0] === T && j[2], l = n && q.childNodes[n];
                            ...
                            PSEUDO: function(a, b) {
                                var d,
                                    e = D.pseudos[a] || D.setFilters[a.toLowerCase()] || c.error("unsupported pseudo: " + a);
                                return e[R] ?
                                    e(b) :
                                    e.length > 1 ?
                                    ((d = [a, a, "", b]),
                        ...
                        pseudos: {
                            ...
                            lang: f(function(a) {
                                return (
                                    ub.test(a || "") || c.error("unsupported lang: " + a),
                    ...
                    for (A in { radio: !0, checkbox: !0, file: !0, password: !0, image: !0 }) D.pseudos[A] = m(A);
                    for (A in { submit: !0, reset: !0 }) D.pseudos[A] = n(A);
                ...
                var c,
                    ...
                    m = {
                        ...
                        remove: function() {
                            return (
                                j &&
                                kb.each(arguments, function(a, b) {
                                    for (var d;
                ...
                (kb.support = (function(b) {
                    ...
                    if (
                        (l.setAttribute("className", "t"),
                            ...
                            (d = l.getElementsByTagName("a")[0]), !d || !d.style || !c.length)
                    )
                        return b;
                        ...
                        kb(function() {
                            ...
                            g &&
                                ((c = Y.createElement("div")),
                                    ...
                                    kb.swap(g, null != g.style.zoom ? { zoom: 1 } : {}, function() {
            ...
            kb.fn.extend({
                    ...
                    toggleClass: function(a, b) {
                        ...
                        return this.each(
                            ...
                            function() {
                                if ("string" === c)
                                    for (var e, f = 0, g = kb(this), h = b, i = a.match(mb) || [];
                                        (e = i[f++]);)(h = d ? h : !g.hasClass(e)), g[h ? "addClass" : "removeClass"](e);
                        ...
                        return arguments.length ?
                            ((e = kb.isFunction(a)),
                                this.each(function(c) {
                                    var f;
                                    1 === this.nodeType &&
                                        ((f = e ? a.call(this, c, kb(this).val()) : a),
                                            null == f ?
                                            (f = "") :
                                            "number" == typeof f ?
                                            (f += "") :
                                            kb.isArray(f) &&
                                            (f = kb.map(f, function(a) {
                                                return null == a ? "" : a + "";
                                            })),
                            ...
                            f ?
                            ((d = kb.valHooks[f.type] || kb.valHooks[f.nodeName.toLowerCase()]), d && "get" in d && (c = d.get(f, "value")) !== b ? c : ((c = f.value), "string" == typeof c ? c.replace(Fb, "") : null == c ? "" : c)) :
                            void 0;
                    },
                }),
                kb.extend({
                    ...
                    attr: function(a, c, d) {
                        ...
                        return a && 3 !== g && 8 !== g && 2 !== g ?
                            ...
                            kb.prop(a, c, d) :
                            ((1 === g && kb.isXMLDoc(a)) || ((c = c.toLowerCase()), (e = kb.attrHooks[c] || (kb.expr.match.bool.test(c) ? Db : Cb))),
                                d === b ?
                                e && "get" in e && null !== (f = e.get(a, c)) ?
                                f :
                                ((f = kb.find.attr(a, c)), null == f ? b : f) :
                                null !== d ?
                ...
                kb.support.hrefNormalized ||
                kb.each(["href", "src"], function(a, b) {
                    kb.propHooks[b] = {
                        get: function(a) {
                ...
                kb.support.optSelected ||
                (kb.propHooks.selected = {
                    get: function(a) {
                        var b = a.parentNode;
                ...
                kb.each(["radio", "checkbox"], function() {
                    ...
                    kb.support.checkOn ||
                        (kb.valHooks[this].get = function(a) {
                ...
                add: function(a, c, d, e, f) {
                    ...
                    if (r) {
                        for (
                            ...
                            d.guid || (d.guid = kb.guid++),
                            (h = r.events) || (h = r.events = {}),
                            (l = r.handle) ||
                            ((l = r.handle = function(a) {
                            ...
                            (p = (g[2] || "").split(".").sort()),
                            o &&
                            ((k = kb.event.special[o] || {}),
                                (o = (f ? k.delegateType : k.bindType) || o),
                                (k = kb.event.special[o] || {}),
                                (m = kb.extend({ type: o, origType: q, data: e, handler: d, guid: d.guid, selector: f, needsContext: f && kb.expr.match.needsContext.test(f), namespace: p.join(".") }, j)),
                ...
                trigger: function(c, d, e, f) {
                    ...
                    if (
                        ((i = l = e = e || Y),
                            3 !== e.nodeType &&
                            8 !== e.nodeType &&
                            !Ob.test(o + kb.event.triggered) &&
                            (o.indexOf(".") >= 0 && ((p = o.split(".")), (o = p.shift()), p.sort()),
                                (h = 0 > o.indexOf(":") && "on" + o),
                                (c = c[kb.expando] ? c : new kb.Event(o, "object" == typeof c && c)),
                                (c.isTrigger = f ? 2 : 3),
                                (c.namespace = p.join(".")),
                                (c.namespace_re = c.namespace ? RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null),
                                (c.result = b),
                                c.target || (c.target = e),
                                (d = null == d ? [c] : kb.makeArray(d, [c])),
                                (k = kb.event.special[o] || {}),
                    ...
                    filter: function(a, c) {
                        ...
                        return (
                            ...
                            ((e = a.target.ownerDocument || Y),
                                ...
                                (a.pageY = c.clientY + ((f && f.scrollTop) || (d && d.scrollTop) || 0) - ((f && f.clientTop) || (d && d.clientTop) || 0))), !a.relatedTarget && h && (a.relatedTarget = h === a.target ? c.toElement : h),
            ...
            (kb.Event = function(a, c) {
                return this instanceof kb.Event ?
                    (a && a.type ? ((this.originalEvent = a), (this.type = a.type), (this.isDefaultPrevented = a.defaultPrevented || a.returnValue === !1 || (a.getPreventDefault && a.getPreventDefault()) ? i : j)) : (this.type = a),
                        c && kb.extend(this, c),
                        (this.timeStamp = (a && a.timeStamp) || kb.now()),
                        (this[kb.expando] = !0),
                        b) :
                    new kb.Event(a, c);
            }),
            ...
            kb.each({ mouseenter: "mouseover", mouseleave: "mouseout" }, function(a, b) {
                ...
                kb.support.submitBubbles ||
                (kb.event.special.submit = {
                    setup: function() {
                        return kb.nodeName(this, "form") ?
                            !1 :
                            (kb.event.add(this, "click._submit keypress._submit", function(a) {
                                    var c = a.target,
                                        d = kb.nodeName(c, "input") || kb.nodeName(c, "button") ? c.form : b;
                                    d &&
                                        !kb._data(d, "submitBubbles") &&
                                        (kb.event.add(d, "submit._submit", function(a) {
                                                a._submit_bubble = !0;
                                            }),
                ...
                kb.support.changeBubbles ||
                (kb.event.special.change = {
                    setup: function() {
                        return Lb.test(this.nodeName) ?
                            (("checkbox" === this.type || "radio" === this.type) &&
                                (kb.event.add(this, "propertychange._change", function(a) {
                            ...
                            (kb.event.add(this, "beforeactivate._change", function(a) {
                                    var b = a.target;
                                    Lb.test(b.nodeName) &&
                                        !kb._data(b, "changeBubbles") &&
                ...
                kb.support.focusinBubbles ||
                kb.each({ focus: "focusin", blur: "focusout" }, function(a, b) {
                    var c = 0,
                        d = function(a) {
            ...
            kb.fn.extend({
                ...
                kb.extend({
                    clone: function(a, b, c) {
                        ...
                        if (
                            (kb.support.html5Clone || kb.isXMLDoc(a) || !Wb.test("<" + a.nodeName + ">") ? (f = a.cloneNode(!0)) : ((ic.innerHTML = a.outerHTML), ic.removeChild((f = ic.firstChild))), !((kb.support.noCloneEvent && kb.support.noCloneChecked) || (1 !== a.nodeType && 11 !== a.nodeType) || kb.isXMLDoc(a)))
                        )
                    ...
                    buildFragment: function(a, b, c, d) {
                        ...
                        for (h && m.removeChild(h), kb.support.appendChecked || kb.grep(u(o, "input"), v), p = 0;
                            (f = o[p++]);)
                            if ((!d || -1 === kb.inArray(f, d)) && ((g = kb.contains(f.ownerDocument, f)), (h = u(m.appendChild(f), "script")), g && r(h), c))
                                for (e = 0;
                                    (f = h[e++]);) dc.test(f.type || "") && c.push(f);
                        return (h = null), m;
                    },
            ...
            kb.fn.extend({
                ...
                kb.extend({
                    ...
                    style: function(a, c, d, e) {
                        if (a && 3 !== a.nodeType && 8 !== a.nodeType && a.style) {
                            ...
                            if (
                                ((g = typeof d),
                                    "string" === g && (f = tc.exec(d)) && ((d = (f[1] + 1) * f[2] + parseFloat(kb.css(a, c))), (g = "number")), !(
                                        null == d ||
                                        ("number" === g && isNaN(d)) ||
                                        ("number" !== g || kb.cssNumber[i] || (d += "px"), kb.support.clearCloneStyle || "" !== d || 0 !== c.indexOf("background") || (j[c] = "inherit"), h && "set" in h && (d = h.set(a, d, e)) === b)
                                    ))
                            )
                                try {
                                    j[c] = d;
                    ...
                    css: function(a, c, d, e) {
                        var f,
                            ...
                            i = kb.camelCase(c);
                        return (
                            (c = kb.cssProps[i] || (kb.cssProps[i] = w(a.style, i))),
                ...
                ((kc = function(b) {
                    ...
                    (lc = function(a, c, d) {
                        ...
                        return (
                            h &&
                            ("" !== i || kb.contains(a.ownerDocument, a) || (i = kb.style(a, c)),
                                sc.test(i) && qc.test(c) && ((e = j.width), (f = j.minWidth), (g = j.maxWidth), (j.minWidth = j.maxWidth = j.width = i), (i = h.width), (j.width = e), (j.minWidth = f), (j.maxWidth = g))),
                            i
                        );
                    })) :
                ...
                kb.each(["height", "width"], function(a, c) {
                    kb.cssHooks[c] = {
                        get: function(a, d, e) {
                            return d ?
                                0 === a.offsetWidth && pc.test(kb.css(a, "display")) ?
                                kb.swap(a, vc, function() {
                                    return B(a, c, e);
                                }) :
                                B(a, c, e) :
                                b;
                ...
                kb(function() {
                    kb.support.reliableMarginRight ||
                        (kb.cssHooks.marginRight = {
                            get: function(a, c) {
                                return c ? kb.swap(a, { display: "inline-block" }, lc, [a, "marginRight"]) : b;
                            },
                        }), !kb.support.pixelPosition &&
                        kb.fn.position &&
                        kb.each(["top", "left"], function(a, c) {
                            kb.cssHooks[c] = {
                                get: function(a, d) {
                ...
                kb.expr &&
                kb.expr.filters &&
                ((kb.expr.filters.hidden = function(a) {
            ...
            kb.each(["ajaxStart", "ajaxStop", "ajaxComplete", "ajaxError", "ajaxSuccess", "ajaxSend"], function(a, b) {
                ...
                kb.extend({
                    ...
                    ajaxSettings: {
                        ...
                        accepts: { "*": Sc, text: "text/plain", html: "text/html", xml: "application/xml, text/xml", json: "application/json, text/javascript" },
                    ...
                    ajax: function(a, c) {
                        function d(a, c, d, e) {
                            ...
                            2 !== u &&
                                ((u = 2),
                                    ...
                                    (t = J(m, t, w, f)),
                                    f ?
                                    (m.ifModified && ((v = w.getResponseHeader("Last-Modified")), v && (kb.lastModified[g] = v), (v = w.getResponseHeader("etag")), v && (kb.etag[g] = v)),
                                    ...
                                    q.fireWith(n, [w, x]),
                                    j && (o.trigger("ajaxComplete", [w, m]), --kb.active || kb.event.trigger("ajaxStop")));
                        }
                            ...
                            w = {
                                ...
                                getResponseHeader: function(a) {
                                    ...
                                    if (2 === u) {
                                        if (!l)
                                            for (l = {};
                                                (b = Kc.exec(h));) l[b[1].toLowerCase()] = b[2];
                                        b = l[a.toLowerCase()];
                                    }
                        ...
                        if (
                            ((p.promise(w).complete = q.add),
                                (w.success = w.done),
                                (w.error = w.fail),
                                (m.url = ((a || m.url || Fc) + "").replace(Ic, "").replace(Nc, Ec[1] + "//")),
                                ...
                                (m.dataTypes = kb
                                    ...
                                    .match(mb) || [""]),
                                null == m.crossDomain &&
                                ((e = Oc.exec(m.url.toLowerCase())), (m.crossDomain = !(!e || (e[1] === Ec[1] && e[2] === Ec[2] && (e[3] || ("http:" === e[1] ? "80" : "443")) === (Ec[3] || ("http:" === Ec[1] ? "80" : "443")))))),
            ...
            kb.ajaxSetup({
                ...
                kb.ajaxPrefilter("json jsonp", function(c, d, e) {
                    ...
                    return i || "jsonp" === c.dataTypes[0] ?
                        ((f = c.jsonpCallback = kb.isFunction(c.jsonpCallback) ? c.jsonpCallback() : c.jsonpCallback),
                ...
                ed = {
                    "*": [
                        function(a, b) {
                            ...
                            if (g && g[3] !== f) {
                                (f = f || g[3]), (e = e || []), (g = +d || 1);
                                do(h = h || ".5"), (g /= h), kb.style(c.elem, a, g + f);
            ...
            (R.prototype = {
                ...
                run: function(a) {
                    ...
                    return (
                        (this.pos = b = this.options.duration ? kb.easing[this.easing](a, this.options.duration * a, 0, 1, this.options.duration) : a),
            ...
            kb.each(["toggle", "show", "hide"], function(a, b) {
                ...
                (kb.speed = function(a, b, c) {
                    ...
                    return (
                        (d.duration = kb.fx.off ? 0 : "number" == typeof d.duration ? d.duration : d.duration in kb.fx.speeds ? kb.fx.speeds[d.duration] : kb.fx.speeds._default),
                ...
                (kb.fx.speeds = { slow: 600, fast: 200, _default: 400 }),
                (kb.fx.step = {}),
                kb.expr &&
                kb.expr.filters &&
                (kb.expr.filters.animated = function(a) {
                    ...
                    return g ?
                        ((c = g.documentElement),
                            ...
                            (typeof f.getBoundingClientRect !== W && (e = f.getBoundingClientRect()),
                                (d = T(g)), { top: e.top + (d.pageYOffset || c.scrollTop) - (c.clientTop || 0), left: e.left + (d.pageXOffset || c.scrollLeft) - (c.clientLeft || 0) }) :
                            e) :
                        void 0;
                }),
                (kb.offset = {
                    ...
                    position: function() {
                        if (this[0]) {
                            var a,
                                ...
                                d = this[0];
                            return (
                                "fixed" === kb.css(d, "position") ?
                                (b = d.getBoundingClientRect()) :
                                ((a = this.offsetParent()), (b = this.offset()), kb.nodeName(a[0], "html") || (c = a.offset()), (c.top += kb.css(a[0], "borderTopWidth", !0)), (c.left += kb.css(a[0], "borderLeftWidth", !0))), { top: b.top - c.top - kb.css(d, "marginTop", !0), left: b.left - c.left - kb.css(d, "marginLeft", !0) }
                            );
                        }
                    },
...
(function(a) {
    ...
    a(document).on("click.bs.collapse.data-api", '[data-toggle="collapse"]', "[data-toggle=childcollapse1]", function(c) {
        var d,
            e = a(this),
        ...
        (k &&
            ...
            .not(e)
            .addClass("collapsed"),
            $('[data-toggle=childcollapse1]').toggleClass("glyphicon-chevron-down glyphicon-chevron-right "),

            e.toggleClass("collapsed", g.hasClass("in"))),

        b.call(g, i);
    });
    a(document).on("click.bs.collapse.data-api", '[data-toggle="collapse2"]', "[data-toggle=childcollapse2]", function(c) {
        var d,
            e = a(this),
            f = e.attr("data-target") || c.preventDefault() || ((d = e.attr("href")) && d.replace(/.*(?=#[^\s]+$)/, "")),
            g = a(f),
        ...
        (k &&
            ...
            .not(e)
            .addClass("collapsed"),
            $('[data-toggle=childcollapse2]').toggleClass("glyphicon-chevron-down glyphicon-chevron-right "),
            ...
            if (this.affixed !== i) {
                ...
                this.$element.trigger(k),
                    ...
                    ((this.affixed = i),
                        ...
                        .removeClass(c.RESET)
                        .addClass(j)
                        .trigger(j.replace("affix", "affixed") + ".bs.affix"),
...
(function(a) {
    function b(a, b, e) {
        var f = a[0],
            ...
            h = e == _update ? { checked: f[l], disabled: f[n], indeterminate: "true" == a.attr(_indeterminate) || "false" == a.attr(_determinate) } : f[g];
    ...
    function d(a, b, c) {
        var d = a[0],
            ...
            q = f(a, p + g(d[_type])),
            r = f(a, b + g(d[_type]));
        !1 !== d[b] && ((k || !c || "force" == c) && (d[b] = !1), h(a, i, p, c)), !d[n] && f(a, _cursor, !0) && e.find("." + j).css(_cursor, "pointer"),
            e[_remove](r || f(a, b) || ""),
    ...
    (a.fn[i] = function(f, g) {
        ...
        var p = a.extend({ checkedClass: l, disabledClass: n, indeterminateClass: _indeterminate, labelHover: !0 }, f),
            q = p.handle,
        ...
        return (
            ("checkbox" == q || q == k) && (h = 'input[type="' + q + '"]'), -50 > w && (w = -50),
            o(this),
            m.each(function() {
                var f = a(this);
                e(f);
                var g = this,
                    ...
                    m = -w + "%",
                    o = 100 + 2 * w + "%",
                    o = { position: "absolute", top: m, left: m, display: "block", width: o, height: o, margin: 0, padding: 0, background: "#fff", border: 0, opacity: 0 },
                    m = _mobile ? { position: "absolute", visibility: "hidden" } : w ? o : { position: "absolute", opacity: 0 },
                ...
                y &&
                    ...
                    (A = f
                        .wrap(A + "/>")[_callback]("ifCreated")
                        .parent()
                        .append(p.insert)),
                    (o = a('<ins class="' + j + '"/>')
                        .css(o)
                        .appendTo(A)),
                    f.data(i, { o: p, s: f.attr("style") }).css(m),
                    p.inheritClass && A[_add](g.className || ""),
                    p.inheritID && h && A.attr("id", i + "-" + h),
                    "static" == A.css("position") && A.css("position", "relative"),
                    b(f, !0, _update),
                    x.length &&
                    x.on(_click + ".i mouseover.i mouseout.i " + _touch, function(c) {
                        var d = c[_type],
                            e = a(this);
                        if (!g[n]) {
                            if (d == _click) {
                    ...
                    f.on(_click + ".i focus.i blur.i keyup.i keydown.i keypress.i", function(a) {
                        ...
                        return (
                            ...
                            !1 :
                            "keydown" == b && 32 == a ?
                            ((g[_type] == k && g[l]) || (g[l] ? d(f, l) : c(f, l)), !1) :
                            void("keyup" == b && g[_type] == k ? !g[l] && c(f, l) : /us|ur/.test(b) && A["blur" == b ? _remove : _add](s))
                        );
                    }),
    ...
    function c(b, c) {
        if (!b.hasClass("stepper-input")) {
            ...
            b.addClass("stepper-input")
                ...
                .after('<span class="stepper-arrow up">' + c.labels.up + '</span><span class="stepper-arrow down">' + c.labels.down + "</span>");
            var i = b.parent(".stepper"),
                k = a.extend({ $stepper: i, $input: b, $arrow: i.find(".stepper-arrow"), min: void 0 === typeof f || isNaN(f) ? !1 : f, max: void 0 === typeof g || isNaN(g) ? !1 : g, step: void 0 === typeof h || isNaN(h) ? 1 : h, timer: null },
                    c
                );
    ...
    function e(b) {
        ...
        if (!c.$input.is(":disabled") && !c.$stepper.hasClass("disabled")) {
            ...
            g(c, d),
                a("body").on("touchend.stepper mouseup.stepper", c, f);
        }
    }
    ...
    function d(b, c) {
        if (!b.hasClass("selecter-element")) {
            ...
            var q = "",
                s = "";
            (s += "<" + k + ' class="selecter ' + c.customClass),
            C ? (s += " mobile") : c.cover && (s += " cover"),
                (s += c.multiple ? " multiple" : " closed"),
                c.disabled && (s += " disabled"),
                (s += '" tabindex="' + c.tabIndex + '">'),
                (s += "</" + k + ">"),
                c.multiple ||
                ((q += '<span class="selecter-selected' + ("" !== c.label ? " placeholder" : "") + '">'),
                    (q += a("<span></span>")
                        .text(v("" !== h.text() ? h.text() : c.label, c.trim))
                        .html()),
                    (q += "</span>")),
                (q += '<div class="selecter-options">'),
                (q += "</div>"),
                b.addClass("selecter-element").wrap(s).after(q);
            var t = b.parent(".selecter"),
                u = a.extend({ $select: b, $allOptions: d, $options: g, $selecter: t, $selected: t.find(".selecter-selected"), $itemsWrapper: t.find(".selecter-options"), index: -1, guid: z++ }, c);
            e(u),
                u.multiple || r(j, u),
                void 0 !== a.fn.scroller && u.$itemsWrapper.scroller(),
                ...
                u.$select.on("change.selecter", u, n),
                C ||
                (u.$selecter.on("focus.selecter", u, o).on("blur.selecter", u, p),
    ...
    function e(b) {
        for (var c = "", d = b.links ? "a" : "span", e = 0, f = 0, g = b.$allOptions.length; g > f; f++) {
            ...
            if ("OPTGROUP" === h[0].tagName)(c += '<span class="selecter-group'), h.is(":disabled") && (c += " disabled"), (c += '">' + h.attr("label") + "</span>");
                ...
                var i = h.val();
                h.attr("value") || h.attr("value", i),
                    (c += "<" + d + ' class="selecter-item'),
                    h.is(":selected") && (c += " selected"),
                    h.is(":disabled") && (c += " disabled"),
                    (c += '" '),
                    (c += b.links ? 'href="' + i + '"' : 'data-value="' + i + '"'),
    ...
    function h(a) {
        var b = a.data;
        b.$selecter.off("touchmove.selecter touchend.selecter click.selecter"),
            (b.timer = x(b.timer, 1e3, function() {
    ...
    function j(a) {
        ...
        if (!b.$selecter.hasClass("open")) {
            ...
            b.index >= 0 ? b.$items.eq(b.index).position() : { left: 0, top: 0 },
                c.top + e > d && b.$selecter.addClass("bottom"),
                b.$itemsWrapper.show(),
                b.$selecter.removeClass("closed").addClass("open"),
                E.on("click.selecter-" + b.guid, ":not(.selecter-options)", b, k),
                s(b);
        }
    }
    ...
    function q(b) {
        ...
        if (13 === b.keyCode) c.$selecter.hasClass("open") && (l(b), r(c.index, c)), t(c);
            ...
            if (a.inArray(b.keyCode, B ? [38, 40, 37, 39] : [38, 40]) > -1)(e += 38 === b.keyCode || (B && 37 === b.keyCode) ? -1 : 1), 0 > e && (e = 0), e > d && (e = d);
                ...
                var f,
                    g,
                    h = String.fromCharCode(b.keyCode).toUpperCase();
    ...
    function r(a, b) {
        ...
        if (!e) {
            if (-1 === a && "" !== b.label) b.$selected.html(b.label);
                ...
                var f = c.html();
                c.data("value"),
                    b.multiple ? b.$options.eq(a).prop("selected", !0) : (b.$selected.html(f).removeClass("placeholder"), b.$items.filter(".selected").removeClass("selected"), (b.$select[0].selectedIndex = a)),
                    c.addClass("selected");
            }
    ...
    function s(b) {
        var c = b.index >= 0 ? b.$items.eq(b.index).position() : { left: 0, top: 0 };
    ...
    var z = 0,
        ...
        D = B && C,
        E = null,
        F = { callback: a.noop, cover: !1, customClass: "", label: "", external: !1, links: !1, trim: 0 },
        G = {
            defaults: function(b) {
            ...
            destroy: function() {
                return a(this).each(function(b, c) {
                    ...
                    d &&
                        (d.$selecter.hasClass("open") && d.$selecter.find(".selecter-selected").trigger("click.selecter"),
                            void 0 !== a.fn.scroller && d.$selecter.find(".selecter-options").scroller("destroy"),
                            (d.$select[0].tabIndex = d.tabIndex),
                            d.$selected.remove(),
                            d.$itemsWrapper.remove(),
                            d.$selecter.off(".selecter"),
                            d.$select.off(".selecter").removeClass("selecter-element").show().unwrap());
                });
            },
            refresh: function() {
                return a(this).each(function(b, c) {
    ...
    a(function() {
        a(".tooltip-demo").tooltip({ selector: "[data-toggle=tooltip]", container: "body" }),
            a("input[type='number']").stepper(),
            a(".selecter_1").selecter(),
            a(".selecter_2").selecter(),
            a(".selecter_3").selecter(),
            a(".selecter_4").selecter(),
            a(".selecter_5").selecter(),
            a(".selecter_6").selecter(),
            a(".checkbox input").iCheck({ checkboxClass: "icheckbox_flat", increaseArea: "20%" }),
            a(".radio input").iCheck({ radioClass: "iradio_flat", increaseArea: "20%" }),
